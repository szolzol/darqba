<template>
    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-white dark:border-gray-700">
        ...
        <a href="#">
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-red-800 dark:text-red-800">Need a help in Claim?</h5>
        </a>
        <p class="mb-3 font-normal text-black dark:text-black">Go to this step by step guideline process on how to
            certify for your weekly benefits:</p>
        <NuxtLink href="/posts/post/12" class="inline-flex items-center text-blue-600 hover:underline">
            See our guideline
